...
const Home = () => {
  ...
  const achievements = [
    ...
    { number: '4', label: 'Service Areas', icon: '⚙️', pulse: 'secondary' },
          ...
          <div className="about-grid">
            ...
            <div className="about-content">
              ...
              <h2 className="section-title">
                Engineering the Future of Central Asia
              </h2>
              ...
              <div className="company-highlight">
                ...
                <p className="highlight-text">
                  We've rapidly emerged as a leading force in IT, Engineering, and Technology sectors in Tajikistan.
                </p>
              </div>
              ...
              <div className="mission-statement">
                ...
                <div className="mission-content">
                  <h4>Our Mission</h4>
                  <p>To deliver innovative solutions and high-quality services in Information Technology, Engineering, and Technology projects, becoming the preferred partner for engineering solutions in Central Asia.</p>
                </div>
              </div>
        ...
        <div className="container">
          ...
          <div className="services-grid">
            ...
            <ServiceCard 
              ...
              description="High-grade Technology services for both governmental and private sectors, specializing in urban development and infrastructure projects."
